...
@Component({
  selector: 'app-bus-right-sidebar',
   imports: [ CommonModule,RouterLink,CommonCounterComponent,
    BsDatepickerModule,DatePickerModule,FormsModule,MatSliderModule
  ],
  templateUrl: './bus-right-sidebar.component.html',
  styleUrl: './bus-right-sidebar.component.scss',
})
export class BusRightSidebarComponent {
