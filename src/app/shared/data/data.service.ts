      ...
      menu:[
        ...
        },
        {
          ...
          subMenus: [
            ...
            {
              menuValue: 'Bus',
              route: routes.customerBusBooking,
              hasSubRoute: false,
              base: "customer-bus-booking"
            },
          ],
        },
        {
  ...
  public sideBar: SideBar[] = [
    {
      ...
      menu: [
        ...
        {
          menuValue: '',
          img: 'assets/img/bg/coming-soon.jpg',
          homeName:'Coming Soon',
          hasSubRoute: false,
          showSubRoute: false,
          base: '',
          page: '',
