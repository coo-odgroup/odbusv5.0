...
//  },
  ...
  { path: 'edit-tour', loadComponent: () => import('./features/tour/edit-tour/edit-tour.component').then(m => m.EditTourComponent) },
       ...
       { path: 'bus', loadComponent: () => import('./features/bus/bus.component').then((m) => m.BusComponent),
        children:[
          { path: 'bus-list', loadComponent: () => import('./features/bus/bus-list/bus-list.component').then(m => m.BusListComponent) },
          { path: 'bus-left-sidebar', loadComponent: () => import('./features/bus/bus-left-sidebar/bus-left-sidebar.component').then(m => m.BusLeftSidebarComponent) },
          { path: 'bus-right-sidebar', loadComponent: () => import('./features/bus/bus-right-sidebar/bus-right-sidebar.component').then(m => m.BusRightSidebarComponent) },
          { path: 'bus-details', loadComponent: () => import('./features/bus/bus-details/bus-details.component').then(m => m.BusDetailsComponent) },
          { path: 'bus-booking', loadComponent: () => import('./features/bus/bus-booking/bus-booking.component').then(m => m.BusBookingComponent) },
          { path: 'bus-booking-confirmation', loadComponent: () => import('./features/bus/bus-booking-confirmation/bus-booking-confirmation.component').then(m => m.BusBookingConfirmationComponent) },
          { path: 'add-bus', loadComponent: () => import('./features/bus/add-bus/add-bus.component').then(m => m.AddBusComponent) },
          { path: 'edit-bus', loadComponent: () => import('./features/bus/edit-bus/edit-bus.component').then(m => m.EditBusComponent) },
          ]
        },
...
{ path: 'index-rtl', loadComponent: () => import('./features/pages/index-rtl/index-rtl.component').then(m => m.IndexRtlComponent) },
      ...
      { path: 'customer-bus-booking', loadComponent: () => import('./features/user/customer-bus-booking/customer-bus-booking.component').then(m => m.CustomerBusBookingComponent) },
  ...
  { path: 'integration-settings', loadComponent: () => import('./features/user/settings/integration-settings/integration-settings.component').then(m => m.IntegrationSettingsComponent) },
      ...
      { path: 'bus-booking', loadComponent: () => import('./features/agent/bus-booking/bus-booking.component').then(m => m.BusBookingComponent) },
